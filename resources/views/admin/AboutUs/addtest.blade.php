...
@section('content')
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                                action="{{ route('about-us.store') }}" enctype="multipart/form-data" method="post">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="en_our_goals">Our Goals
                                        in English
                                        <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <div id="steps_processs">
                                        <div class="steps_process">
                                            ...
                                            <input type="text" id="steps_processs[0][en_name]"
                                                ...
                                                value="{{ old('steps_processs.0.en_name') }}" class="form-control  "><br>
                                            ...
                                            <input type="text" id="steps_processs[0][nl_name]"
                                                ...
                                                value="{{ old('steps_processs.0.nl_name') }}" class="form-control  "><br>
    ...
    <script>
        document.getElementById('add-more-steps').addEventListener('click', function() {
            ...
            <label for="steps_processs[${index}][step_no]">Dutch Name:</label>
                                            <input type="number" id="steps_processs[${index}][step_no]"
                                                name="steps_processs[${index}][step_no]" class="form-control  "><br>
