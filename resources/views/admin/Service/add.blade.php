                                ...
                                <div id="step-1">
                                    <form class="form-horizontal form-label-left" id="form1">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="name" required="required"
                                                    class="form-control  " name="nl_name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align"
                                            ...
                                            <div id="service_benefits">
                                                <div class="service_benefit">
                                                    ...
                                                    <input type="text" id="service_benefits[0][en_name]"
                                                        ...
                                                        value="{{ old('service_benefits.0.en_name') }}"  class="form-control  "><br>
                                                    ...
                                                    <input type="text" id="service_benefits[0][nl_name]"
                                                        ...
                                                        value="{{ old('service_benefits.0.nl_name') }}"  class="form-control  "><br>
                                                    <br>
                                            ...
                                            <div class="service_process">
                                                ...
                                                <div class="process_procedure">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('service_processs.0.process_procedures.0.en_name') }}"  class="form-control  "><br>
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('service_processs.0.process_procedures.0.nl_name') }}"  class="form-control  "><br>
